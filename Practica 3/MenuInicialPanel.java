...
public class MenuInicialPanel extends JPanel {
    ...
    private void putLogin() {//Hacer que no se pueda elegir un nick ya en uso
        ...
        titulo.setHorizontalAlignment(SwingConstants.CENTER);//Establecemos la alineacion horizontal del texto
        this.add(titulo);

        textField.setBounds(130, 130, 165, 40);//Establecemos el tamaño y posicion de la etiqueta
        textField.setHorizontalAlignment(SwingConstants.CENTER);//Establecemos la alineacion horizontal del texto
        textField.setFont(new Font("arial", Font.BOLD, 25));//Establecemos tipo de fuente y  tamaño
        this.add(textField);
        nickname = textField.getText();//El nickname será el introducido por el usuario
    }
    ...
    private void putBoton() {
        ...
        registro.setFont(new Font("arial", Font.BOLD, 25));//Establecemos tipo de fuente y  tamaño
        this.add(registro);
