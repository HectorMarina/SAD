...
public class Line extends Observable {
    ...
    public void insert() {
        ...
        this.setChanged();
        this.notifyObservers(Keyboard.INS);
    }
    ...
    public void deleteChar() {
        ...
        this.setChanged();
        this.notifyObservers(Keyboard.DEL);
    }
    ...
    public void bkspChar() {
        ...
        this.setChanged();
        this.notifyObservers(Keyboard.BKSP);
    }
    ...
    public void goLeft() {
        ...
        this.setChanged();
        this.notifyObservers(Keyboard.LEFT);
    }
    ...
    public void goRight() {
        ...
        this.setChanged();
        this.notifyObservers(Keyboard.RIGHT);
    }
    ...
    public void goHome() {
        ...
        this.pos = 0;
        this.setChanged();
        this.notifyObservers(Keyboard.HOME);
    }
    ...
    public void goEnd() {
        ...
        this.setChanged();
        this.notifyObservers(Keyboard.END);
    }
